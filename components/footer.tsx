...
export function Footer() {
  return (
    <footer className="border-t border-white/[.07] bg-[#080606]">
      <div className="mx-auto grid max-w-6xl gap-10 px-5 py-14 sm:px-8 md:grid-cols-[1.6fr_repeat(3,1fr)]">
        <div>
          <Logo />
      ...
      <div className="border-t border-white/[.06]">
        <div className="mx-auto flex max-w-6xl flex-col gap-2 px-5 py-6 text-xs text-zinc-500 sm:flex-row sm:items-center sm:justify-between sm:px-8">
